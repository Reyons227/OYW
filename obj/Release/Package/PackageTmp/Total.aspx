<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Total.aspx.cs" Inherits="OYW19.Total" %>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="active" href="Total.aspx">Total Amount</a></li>
								</ul>
							</li>
