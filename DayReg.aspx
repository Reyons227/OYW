<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="DayReg.aspx.cs" Inherits="OYW19.DayReg" %>
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a class="active" href="DayReg.aspx">Registration on day</a></li>
